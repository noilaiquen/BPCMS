...
class Minify
{
	...
	public function __construct($config = array())
	{
		...
		$this->assets_dir         = $this->ci->config->item('assets_dir', 'minify') ?$this->ci->config->item('assets_dir', 'minify'): $this->assets_dir;
		$this->css_dir            = $this->ci->config->item('css_dir', 'minify') ?$this->ci->config->item('css_dir', 'minify'): $this->css_dir;
		$this->js_dir             = $this->ci->config->item('js_dir', 'minify') ?$this->ci->config->item('js_dir', 'minify'): $this->js_dir;
		$this->css_file           = $this->ci->config->item('css_file', 'minify') ?$this->ci->config->item('css_file', 'minify'): $this->css_file;
		$this->js_file            = $this->ci->config->item('js_file', 'minify') ?$this->ci->config->item('js_file', 'minify'): $this->js_file;
		$this->auto_names         = $this->ci->config->item('auto_names', 'minify') ?$this->ci->config->item('auto_names', 'minify'): $this->auto_names;
		$this->compress           = $this->ci->config->item('compress', 'minify') ?$this->ci->config->item('compress', 'minify'): $this->compress;
		$this->compression_engine = $this->ci->config->item('compression_engine', 'minify') ?$this->ci->config->item('compression_engine', 'minify'): $this->compression_engine;
