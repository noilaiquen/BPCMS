...
<link href="<?=PATH_URL.'assets/css/admin/'?>excel.css" rel="stylesheet" type="text/css" id="style_color" />
<!-- END THEME STYLES -->
...
<div class="page-header navbar navbar-fixed-top">
	...
	<div class="page-header-inner">
		<!-- BEGIN LOGO -->
		<div class="page-logo">DASHBOARD</div>
		<!-- END LOGO -->
	...
	<div class="page-sidebar-wrapper">
		...
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
				...
				<!-- <li class="start<?php if($this->uri->segment(2)==''){ print ' active'; }?>"><a href="<?=PATH_URL_ADMIN?>"><i class="icon-home"></i><span class="title">Dashboard</span></a></li> -->
				<?=modules::run('admincp/menu')?>
				<li class="last<?php if($this->uri->segment(2)=='setting'){ print ' active'; }?>"><a href="<?=PATH_URL_ADMIN.'setting'?>"><i class="icon-settings"></i><span class="title">Settings</span></a></li>
			</ul>
			<!-- END SIDEBAR MENU -->
		</div>
	</div>
