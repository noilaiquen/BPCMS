...
<script type="text/javascript" src="<?=PATH_URL.'assets/js/admin/login.min.js'?>"></script>
...
<div id="main">
	<div class="logo"></div>
	<div class="bg_login">
		<div class="divInpUsername"><input onkeypress="return EnterLogin(event)" class="inpLogin" type="text" id="loginUser" placeholder="Username" /></div>
		<div class="divInpPass"><input onkeypress="return EnterLogin(event)" class="inpLogin" type="password" id="loginPass" placeholder="Password" /></div>
