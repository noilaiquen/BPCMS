	...
	<div class="col-md-12">
		...
		<div class="portlet box grey-cascade">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-globe"></i>Danh mục sản phẩm
				</div>
				<div class="tools">
					...
					<div class="row" style="margin-bottom:15px">
						...
						<div class="col-md-10 col-sm-12">
							<div class="dataTables_filter">
								...
								<label style="margin-bottom:0;margin-left:10px">Chọn ngày:&nbsp;</label>
                        <label style="margin-bottom:0;">Tìm kiếm: <input onkeypress="return enterSearch(event)" id="search_content" placeholder="Nhập tên cần tìm..." type="search" class="form-control input-medium input-inline"></label>
							</div>
						</div>
					</div>
